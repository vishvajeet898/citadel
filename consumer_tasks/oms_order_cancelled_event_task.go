...
func (eventProcessor *EventProcessor) OmsOrderCancelledEventTask(ctx context.Context,
	...
	redisKey := fmt.Sprintf(constants.OmsCancelledOrderEventKey, omsOrderCreateUpdateEvent.Order.Id,
	...
	utils.AddLog(ctx, constants.INFO_LEVEL, utils.GetCurrentFunctionName(),
		map[string]interface{}{
			...
			"event_type":    constants.OmsOrderCancelledEvent,
		}, nil)

	cErr := eventProcessor.ProcessOmsOrderCancelledEvent(ctx, omsOrderCreateUpdateEvent)
	if cErr != nil {
...
func (eventProcessor *EventProcessor) ProcessOmsOrderCancelledEvent(ctx context.Context,
